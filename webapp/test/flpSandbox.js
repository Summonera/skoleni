			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"cdskoleni-display": {
								"semanticObject": "cdskoleni",
								"action": "display",
								"description": "Aplikace pro školení",
								"title": "Školení",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=cd.skoleni",
									"url": sap.ui.require.toUrl("cd/skoleni")
								}
							}
						}
					}
